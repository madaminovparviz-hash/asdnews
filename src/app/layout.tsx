...
export const metadata: Metadata = {
  ...
  description:
    "Церковь христиан Адвентистов Седьмого Дня в Душанбе, Таджикистан. Богослужения каждую субботу: Изучение Библии в 09:00, Божественное служение в 10:30. Добро пожаловать!",
  keywords: [
