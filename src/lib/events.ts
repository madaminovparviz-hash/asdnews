...
const SPECIAL: SpecialEvent[] = [
  ...
  },
  {
    ...
    time: '11:00',
    category: 'children',
    title: { ru: 'Библейский семинар: «Книга пророка Даниила»', tj: 'Семинари Библиявӣ: «Китоби Дониёли пайғамбар»' },
    description: {
      ru: 'Углублённое совместное исследование библейских пророчеств, вопросов веры и надежды.',
      tj: 'Омӯзиши амиқи пешгӯиҳои Библиявӣ, саволҳои имон ва умед.',
    },
  },
  {
    offsetDays: 26,
  ...
  },
  {
    ...
    time: '12:30',
    category: 'community',
    title: { ru: 'Дружеский пикник общины', tj: 'Пикники дӯстонаи ҷамоат' },
    description: {
      ru: 'После богослужения выезжаем на природу: обед, свежий воздух и тёплое братское общение.',
      tj: 'Баъди ибодат ба табиат мебароем: хӯрок, ҳавои тоза ва ҳамсуҳбати гарми бародарӣ.',
    },
  },
];
